...
def most_frequent_viz(txt, name, num_result = 30):
  ...
  try:
    ...
    txt = txt.translate(str.maketrans(' ', ' ', string.punctuation + "ââ-_"))
    txt = txt.lower()
    ...
    plt.savefig(f"{name}_most_frequent_viz.png", dpi=500)

    print("done mfw", f"{name}_most_frequent_viz.png")

    return f"{name}_most_frequent_viz.png"
  except:
    return "ERROR"